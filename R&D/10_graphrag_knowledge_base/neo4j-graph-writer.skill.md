...
description: Safely add nodes, relationships, and structured knowledge to the Mindrian Neo4j knowledge graph. Enforces WHAT/WHY/HOW pre-flight, schema governance, and memory safety for 512MB Render.
license: MIT
allowed-tools:
  - neo4j-cypher
  - read-neo4j-cypher
